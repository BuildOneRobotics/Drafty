    ...
    <nav className="bg-white border-b border-[var(--accent-color)]/20">
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="absolute top-16 left-4 bg-white rounded-2xl border border-[var(--accent-color)]/20 z-50 w-64 overflow-hidden">
            <Link
              href="/"
              onClick={() => setMenuOpen(false)}
              className="flex items-center space-x-3 px-6 py-4 border-b border-[var(--accent-color)]/20 hover:bg-[var(--accent-color)]/5 transition-colors"
            >
            ...
            >
              ...
              <span className="font-medium text-[var(--text-color)]">Dashboard</span>
            </Link>
